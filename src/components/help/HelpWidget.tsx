...
export const HelpWidget = () => {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      case "video": return "bg-[hsl(var(--status-pending-bg))] text-[hsl(var(--status-pending-text))]";
      case "guide": return "bg-[hsl(var(--status-completed-bg))] text-[hsl(var(--status-completed-text))]";
      case "article": return "bg-purple-50 text-purple-700";
